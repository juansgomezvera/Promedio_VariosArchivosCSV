...
double promt1 = 0;// creamos una variable para almacenar el promdeio1 con un valor nulo.
double promt2 = 0;// creamos una variable para almacenar el promdeio2 con un valor nulo.
double promt3 = 0;// creamos una variable para almacenar el promdeio3 con un valor nulo.
double promt4 = 0;// creamos una variable para almacenar el promdeio4 con un valor nulo.
...
double promedios_individuales(const char* archivocvv) //creamos una funcion prom.
{
    ...
    for (int i=0 ; i<rowcount ; i++){ //para cada variable i, tomamos el rowcount y aumentamos en 1.
        ...
        int j=2; //j siempre inicialmente valdrá 0, esta es la columna que vamos a tomar. Contanto la primera columna como 0. Tenemos que tomar de la 2 a la 5.
    ...
    return prom1 and prom2 and prom3 and prom4;
...
double volvernulo(){
    ...
    prom4=0;
    num=0;
    return prom1 and prom2 and prom3 and prom4 and num;
}

double calculo_promediot(){
    promt1=prom1+promt1;
    promt2=prom2+promt2;
    promt3=prom3+promt3;
    promt4=prom4+promt4;
    return promt1 and promt2 and promt3 and promt4;
}
...
int main()
{
    ...
    cout << "El promedio #1 de las notas es: " << prom1 << " " << prom2 << " " << prom3 << " " << prom4 << endl; // imprimimos un mensaje con el promedio.
    calculo_promediot();
    volvernulo();
    promedios_individuales("Promedio10Estud.csv"); //llamamos a la funcion prom antes creada.
    cout << "El promedio #2 de las notas es: " << prom1 << " " << prom2 << " " << prom3 << " " << prom4 << endl; // imprimimos un mensaje con el promedio.
    calculo_promediot();
    volvernulo();
    promedios_individuales("Promedio15Estud.csv"); //llamamos a la funcion prom antes creada.
    cout << "El promedio #3 de las notas es: " << prom1 << " " << prom2 << " " << prom3 << " " << prom4 << endl; // imprimimos un mensaje con el promedio.
    calculo_promediot();
    volvernulo();
    promedios_individuales("Promedio20Estud.csv"); //llamamos a la funcion prom antes creada.
    cout << "El promedio #4 de las notas es: " << prom1 << " " << prom2 << " " << prom3 << " " << prom4 << endl; // imprimimos un mensaje con el promedio.
	calculo_promediot();
    volvernulo();
    promediototal();
    cout << "El promedio total de las notas es: " << promt1 << " " << promt2 << " " << promt3 << " " << promt4 << endl; // imprimimos un mensaje con el promedio.
}